namespace Toronto.Concerts.Native.Controls;

public partial class AnimatedAccordion : ContentView
{
	public AnimatedAccordion()
	{
		InitializeComponent();
    ...
    public static readonly BindableProperty HeaderProperty =
      BindableProperty.Create("Header", typeof(string), typeof(AnimatedAccordion), "");
